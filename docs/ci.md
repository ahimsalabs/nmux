...
| Timings and local smoke | `check_all_real_seconds`, `check_all_user_seconds`, `check_all_sys_seconds`, `local_smoke`, `local_smoke_reattach`, `local_smoke_print_context`, `local_smoke_json_info`, `local_smoke_socket_recreation`, `bundle_elapsed_seconds`, and total GitHub job duration. |
...
`local_smoke_json_info`, and `local_smoke_socket_recreation` results,
