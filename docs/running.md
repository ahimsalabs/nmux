...
Backend-populated OSC 7 working-directory extraction, image placement data, and
hyperlink IDs remain intentionally withheld until the expected backend behavior
