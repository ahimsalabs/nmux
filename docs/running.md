...
tracking and explicit encoder output, origin, wraparound mode state, row-level
dirty state, Kitty graphics placeholder detection, and mode-aware key encoding.
OSC 7 working-directory metadata and image placement data remain intentionally
