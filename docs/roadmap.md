...
- `make local-smoke` runs a default-engine local daemon/client workflow through
  ...
  informational flags, and verifies a fresh daemon on the same socket path does
  not render stale cached state.
