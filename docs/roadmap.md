...
- Continue from stdin byte streaming, opt-in redraw, committed resize display, explicit local echo choice, and daemon-published resize policy toward signal handling.
