...
- Continue from stdin byte streaming, opt-in redraw, and committed resize display toward a fuller terminal frontend loop: local echo choices, richer layout policy, and signal handling.
