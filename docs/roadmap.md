...
- The `libghostty-vt` key encoder is now tested for explicit application-keypad encoding, while broader terminal-derived key forwarding remains a protocol/frontend boundary decision.
