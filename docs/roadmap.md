...
- The `libghostty-vt` safe API is now tested for focus reporting mode and focus event encoding, while focus forwarding remains a protocol/frontend boundary decision.
