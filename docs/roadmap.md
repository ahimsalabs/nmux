...
- Continue from stdin byte streaming and opt-in redraw toward a fuller terminal frontend loop: local echo choices, resize policy publication, and signal handling.
