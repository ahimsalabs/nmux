...
- Continue from stdin byte streaming, opt-in redraw, and resize policy display toward a fuller terminal frontend loop: local echo choices, committed resize updates, and signal handling.
