...
- `libghostty-vt` render-state colors are tested as backend-observable default foreground/background, active palette, and explicit cursor-color state, while nmux still withholds color protocol fields.
