...
backend-observable cursor blink state, render-state default colors/palette and
explicit cursor color, alternate-screen entry/restoration, resize/reflow, styled
