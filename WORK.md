...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  make packaging-archive-verify validates an already-produced opt-in native-VT package archive plus sidecar hash without rebuilding, including archive bytes, extracted layout, package metadata, provenance file hashes, native runtime-library artifacts, dynamic dependency records, and wrapped binary version checks
