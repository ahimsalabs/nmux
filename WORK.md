...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  make packaging-provenance-verify regenerates the opt-in native-VT package provenance manifest and fails if required toolchain, source-mode, locked package, staged-file hash, runtime-library, per-binary libghostty-vt dynamic-dependency, or cargo-tree records are missing
