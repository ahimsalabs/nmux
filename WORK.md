...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  README and docs/running.md show the local-smoke success signature, including the JSON informational subcheck, so first-run users can recognize a completed default workflow through noisy build output
