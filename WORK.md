...
M12: live workspace usability [done]
  ...
  nmux --start --live starts a private managed nmuxd --live-forever --ready-json on a short temporary socket path, waits for daemon readiness internally, attaches, and cleans up the managed daemon when the live client exits
