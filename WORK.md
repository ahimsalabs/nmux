...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  the tracker now includes one warm local Darwin arm64 make check-all timing sample and the Nix-provided flatc version; this is useful evidence, not enough for promotion by itself
