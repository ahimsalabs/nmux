...
M13: backend libghostty-vt extraction [current correctness milestone]
  ...
  optional libghostty-vt coverage includes combining marks, palette-indexed SGR color resolution, bracketed paste mode tracking, and mode-aware key encoding
