...
M12: live workspace usability [done]
  ...
  nmux --print-context reports inherited NMUX_* pane identity without connecting, fails clearly outside nmux, and has nested PTY smoke coverage
...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  the tracker now includes warm local Darwin arm64 make check-all timing samples and the Nix-provided flatc version; this is useful evidence, not enough for promotion by itself
