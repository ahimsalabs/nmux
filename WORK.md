...
M14: post-M13 promotion and product split [decision accepted in ADR 0023]
  ...
  make check-ghostty-vt runs the opt-in libghostty-vt feature suites serially with RUST_TEST_THREADS=1 after a manual Ubuntu promotion-evidence attempt exposed a native-VT test-process segfault under the default parallel Rust test harness
