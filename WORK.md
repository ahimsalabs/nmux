...
M13: backend libghostty-vt extraction [current correctness milestone]
  ...
  current-version live reattach reuses cached terminal modes for initial bracketed-paste and focus-reporting input gates when the daemon sends no surface frame
