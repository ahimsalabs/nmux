...
read-only from persisted state, checks nested context and JSON informational
flags, and proves the client does not reuse stale state after a socket path is
recreated.
